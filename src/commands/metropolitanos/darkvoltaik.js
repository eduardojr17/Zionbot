...
module.exports = class extends Command {
    ...
    run = (interaction) => {
       ...
       const exampleEmbed = new MessageEmbed()
        ...
        .setDescription('*VoltaiK teve um par de anos muito feliz e tranquilo. Tudo estava ótimo com sua parceira Madam Fusion e ele conseguia ver seus outros amigos super-heróis de vez em quando, embora eles não trabalhassem juntos tanto quanto antes. Ele não estava trabalhando muito, mas apenas porque havia conseguido manter os vilões sob controle.
No entanto, tudo mudou para ele depois que ele descobriu que uma de suas melhores amigas, Cyan Nathura, havia se transformado em uma versão nova e mais forte dela mesma, Emerald Nathura. A transformação dela abalou uma parte dele que ele havia trabalhado muito duro para controlar no passado. Ele sentiu uma mistura de ciúme e ambição. Ele não conseguia deixar de pensar em como os cidadãos não o idolatravam como costumavam fazer. De repente, sua vida tranquila ficou muito tranquila para ele e a felicidade se foi.
Ele descobriu através da Madam Fusion que Cyan não era a única transformação acontecendo ao seu redor. Alguns de seus piores inimigos também se tornaram mais fortes. Nesse ponto, ele começou a enlouquecer, e Madam Fusion percebeu, então ela tentou ajudá-lo a se transformar também para que ele pudesse canalizar toda a sua ambição de voltar como o super-herói favorito de todos de uma forma saudável.
Mas, por mais que VoltaiK tentasse, ele não parecia capaz de se transformar. Ele colocou as mãos em um bom grupo de Nebulosa com bastante facilidade, mas, inexplicavelmente, não funcionou com ele. Portanto, ele começou a investigar maneiras alternativas de obter seu aumento de poder, mas ao mergulhar em técnicas mais sombrias, ele decidiu deixar Madam Fusion de fora de suas tentativas.
No final, ele encontrou algo que funcionou para ele - Lutum. Ele foi avisado várias vezes que Lutum afetaria mais do que sua força, que poderia corromper sua personalidade, mas àquela altura ele estava faminto demais para ouvir a razão.
Foi assim que VoltaiK ficou escuro* \n ')
